  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configura los detalles principales de tu prompt
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <label className="flex items-center space-x-2 cursor-pointer">
                      ...
                      <span className="text-sm">Prompt privado</span>
                    </label>
                  </div>
                </div>
              </div>
        ...
        {/* Contenido del Prompt - Sección destacada */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          <Card className="border-purple-500/30 bg-gradient-to-br from-purple-900/10 to-blue-900/10">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-base">
                Este es el núcleo de tu prompt. Escribe aquí las instrucciones que la IA seguirá. 
                Puedes usar Markdown para formatear el texto y hacer tu prompt más claro y estructurado.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Content - Sección destacada */}
                <div className="space-y-4 p-6 bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-xl border-2 border-purple-500/30">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-purple-600 rounded-lg">
                      <Sparkles className="h-5 w-5 text-white" />
                    </div>
                    <div>
                      <Label htmlFor="content" className="text-lg font-semibold text-purple-300">
                        Contenido del Prompt *
                      </Label>
                      <p className="text-sm text-slate-400 mt-1">
                        Escribe aquí el prompt principal que será enviado a la IA. Este es el corazón de tu prompt.
                      </p>
                    </div>
                  </div>
