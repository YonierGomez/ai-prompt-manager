...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between h-14 sm:h-16 px-4 sm:px-6 max-w-7xl mx-auto">
          {/* Logo */}
          ...
          <div className="md:hidden flex items-center gap-1.5 sm:gap-2">
            <Link 
              href="/new" 
              className="inline-flex items-center justify-center p-2 rounded-xl text-white bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 transition-all duration-200"
            >
              <Plus className="h-4 w-4" />
            </Link>
            <button
